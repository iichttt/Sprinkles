...
API.runtime.onInstalled.addListener(() => {
  applyFontSettings().catch(reportFailure("applying font settings"));
...
async function reload() {
  ...
  // Styles go first: they don't need the userScripts API, which stays unavailable until the
  // user turns on "Allow User Scripts" for the extension.
  await refreshStyles();
...
async function registerScripts(global, domains) {
  ...
  try {
    ...
    console.error("Failed to clear previous user scripts:", e);
  }
